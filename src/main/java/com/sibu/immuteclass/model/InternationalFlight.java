...
// #[regen=yes,id=DCE.86AC2A4B-32B2-F9AC-D2CE-E7D02363C898]
// </editor-fold> 
public final class InternationalFlight {
    ...
    {
        intflightID = builder.intflightID;
    ...
    public final String flightID () {
      ...
      @Override
        public int hashCode() {
            int hash = 3;
            hash = 17 * hash + Objects.hashCode(this.intflightID);
            return hash;
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (!Objects.equals(this.intflightID, other.intflightID)) {
                return false;
            }
            return true;
        }
